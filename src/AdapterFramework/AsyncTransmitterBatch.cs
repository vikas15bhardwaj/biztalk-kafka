...
namespace AdapterFramework
{
    ...
    public class AsyncTransmitterBatch : IBTTransmitterBatch
    {
        ...
        {
            TraceHelper.Logger.TraceInfo($"{asyncTransmitter.TraceId}: AsyncTransmitterBatch");
        ...
        {
            TraceHelper.Logger.TraceInfo($"{asyncTransmitter.TraceId}: AsyncTransmitterBatch.BeginBatch");
        ...
        {
            TraceHelper.Logger.TraceInfo($"{asyncTransmitter.TraceId}: AsyncTransmitterBatch.TransmitMessage");
            this.messages.Add(message);
            return false;
        }
        public void Clear ()
        {
            TraceHelper.Logger.TraceInfo($"{asyncTransmitter.TraceId}: AsyncTransmitterBatch.Clear");
            this.messages.Clear();
        }
        public void Done (IBTDTCCommitConfirm commitConfirm)
        {
            TraceHelper.Logger.TraceInfo($"{asyncTransmitter.TraceId}: AsyncTransmitterBatch.Done starts");
            ...
            TraceHelper.Logger.TraceInfo($"{asyncTransmitter.TraceId}: AsyncTransmitterBatch.Done ends");
        }
        ...
        protected virtual void Worker()
        {
            ...
            try
            {
                using (Batch batch = new TransmitResponseBatch(this.transportProxy, new TransmitResponseBatch.AllWorkDoneDelegate(AllWorkDone), this.asyncTransmitter.TraceId))
                {
