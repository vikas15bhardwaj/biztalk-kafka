...
namespace AdapterFramework
{
        ...
        IBTBatchTransmitter
    {
        ...
        protected AsyncTransmitter (
            ...
            Type endpointType,
            int maxBatchSize, string traceId)
            : base(
            name,
            version,
            description,
        ...
        {
            TraceHelper.Logger.TraceInfo($"{TraceId}: AsyncTransmitter.GetBatch");
        ...
        {
            TraceHelper.Logger.TraceInfo($"{TraceId}: AsyncTransmitter.CreateAsyncTransmitterBatch");
        ...
        {
            TraceHelper.Logger.TraceInfo($"{TraceId}: AsyncTransmitter.CreateEndpointParameters");
        ...
        {
            TraceHelper.Logger.TraceInfo($"{TraceId}: AsyncTransmitter.GetEndpoint Start");
            ...
            lock (endpoints)
            {
                TraceHelper.Logger.TraceInfo($"{TraceId}: AsyncTransmitter.GetEndpoint {this.endpointType}");
                ...
                TraceHelper.Logger.TraceInfo($"{TraceId}: AsyncTransmitter.GetEndpoint Ends");
        ...
        {
            TraceHelper.Logger.TraceInfo($"{TraceId}: AsyncTransmitter.Terminate Start");
            ...
            try
            {
                ...
                TraceHelper.Logger.TraceInfo($"{TraceId}: AsyncTransmitter.Terminate leave");
            ...
            TraceHelper.Logger.TraceInfo($"{TraceId}: AsyncTransmitter.Terminate Ends");
        ...
        public bool Enter ()
        {
            TraceHelper.Logger.TraceInfo($"{TraceId}: AsyncTransmitter.Enter");
            return this.control.Enter();
        }

        public void Leave ()
        {
            TraceHelper.Logger.TraceInfo($"{TraceId}: AsyncTransmitter.Leave");
