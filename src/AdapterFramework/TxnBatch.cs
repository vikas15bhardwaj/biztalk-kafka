...
namespace AdapterFramework
{
	...
	{
        public TxnBatch(IBTTransportProxy transportProxy, ControlledTermination control, CommittableTransaction transaction, ManualResetEvent orderedEvent, bool makeSuccessCall, string traceId) : base(transportProxy, makeSuccessCall, traceId)
        {
        ...
        public TxnBatch(IBTTransportProxy transportProxy, ControlledTermination control, IDtcTransaction comTxn, CommittableTransaction transaction, ManualResetEvent orderedEvent, bool makeSuccessCall, string traceId) : base(transportProxy, makeSuccessCall, traceId)
        {
            this.control = control;
            this.comTxn = comTxn;
            this.transaction = transaction;
