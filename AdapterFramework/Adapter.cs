...
namespace AdapterFramework
{
		...
		IPersistPropertyBag
	{
		...
		protected Adapter (
            ...
            string traceId)
		{
            TraceHelper.Logger.TraceIn($"{traceId}: Adapter.Adapter name: {name}");
            Trace.WriteLine($"Adapter.Adapter name: {name}");
		...
		{
            TraceHelper.Logger.TraceIn($"{this.TraceId}: Adapter.Initialize");
		...
		{
            TraceHelper.Logger.TraceIn($"{this.TraceId}: Adapter.Terminate");
		...
		{
            TraceHelper.Logger.TraceIn($"{this.TraceId}: Adapter.Load");
